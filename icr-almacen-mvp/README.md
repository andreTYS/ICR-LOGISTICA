...
- **Menú lateral reorganizado en módulos colapsables** (Almacén, Compras, Proyectos, Administración) en vez de una lista plana — necesario a medida que el ERP suma módulos. Los módulos del roadmap todavía no construidos (Ventas/CRM, Contabilidad, RR.HH.) aparecen atenuados con una etiqueta "Pronto" para que se vea la forma completa del sistema descrita en el PRD.
