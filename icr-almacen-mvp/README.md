...
- **Menú lateral reorganizado en módulos colapsables** (Almacén, Compras, Proyectos, Contabilidad, RR.HH., Administración) en vez de una lista plana — necesario a medida que el ERP suma módulos. Cada módulo agrupa varias pantallas (igual que Almacén): Compras tiene Órdenes de compra / Reabastecimiento / Proveedores; Proyectos tiene Obras-costeo / Clientes; Contabilidad tiene Asientos / Plan de cuentas / Reglas de imputación / Parámetros fiscales; RR.HH. tiene Empleados / Asistencia. El único módulo del roadmap todavía no construido (Ventas/CRM) aparece atenuado con una etiqueta "Pronto".
