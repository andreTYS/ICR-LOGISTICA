...
const ROLE_PERMISSIONS = {
  ...
  SUPERVISOR: [
    ...
    "inventory.stock.get", "inventory.stock.search", "inventory.query", "inventory.dispatch_reservation", "inventory.return_loan",
    ...
    "sales.contract.manage", "sales.query", "store.sale.register", "store.query",
  ...
  CONSULTA: [
    "inventory.stock.get", "inventory.stock.search", "inventory.query", "projects.query", "accounting.query", "rrhh.query", "sales.query", "store.query", "expenses.query",
